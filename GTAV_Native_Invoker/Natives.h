...
namespace ENTITY
{
	...
	static Any GET_ENTITY_ATTACHED_TO(Entity Entity) { return invoke<Any>(0xFE1589F9, Entity); } // 0xFE1589F9
	...
	static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Entity Entity, int xCoord, int yCoord, int zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043A
...
namespace GAMEPLAY
{
	...
	static BOOL IS_STRING_NULL_OR_EMPTY(Any p0) { return invoke<BOOL>(0x42E9F2CA, p0); } // 0x42E9F2CA
...
namespace UI
{
	...
	static void _0x574EE85C(Any p0) { invoke<Void>(0x574EE85C, p0); } // 0x574EE85C
	...
	static Any _0xE7E3C98B(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0xE7E3C98B, p0, p1, p2, p3, p4, p5); } // 0xE7E3C98B
	...
	static void ADD_TEXT_COMPONENT_INTEGER(char* text) { invoke<Void>(0xFE272A57, text); } // 0xFE272A57
...
namespace GRAPHICS
{
	...
	static Any REQUEST_SCALEFORM_MOVIE(Any p0) { return invoke<Any>(0xC67E3DCB, p0); } // 0xC67E3DCB
	...
	static Any _0x215ABBE8(Any p0, Any p1) { return invoke<Any>(0x215ABBE8, p0, p1); } // 0x215ABBE8
	...
	static void _0x3AC9CB55(Any p0) { invoke<Void>(0x3AC9CB55, p0); } // 0x3AC9CB55
...
namespace NETWORK
{
	...
	static Any NETWORK_GET_HOST_OF_SCRIPT(Any p0, Any p1, Any p2) { return invoke<Any>(0x9C95D0BB, p0, p1, p2); } // 0x9C95D0BB
	...
	static Any NETWORK_CREATE_SYNCHRONISED_SCENE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { return invoke<Any>(0xB06FE3FE, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0xB06FE3FE
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xB386713E, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0xB386713E
